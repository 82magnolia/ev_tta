...
class MiniBatchTracker(Tracker):
    ...
    def __init__(self, **kwargs):
        ...
        self.total_train_correct = Accumulator()
        self.total_train_num = Accumulator()
    ...
    def init_epoch(self, mode):
        ...
        if mode == 'train':
            ...
            self.total_train_correct.reset()
            self.total_train_num.reset()
        elif mode == 'val':
    ...
    def get_train_acc(self):
        return float(self.total_train_correct.get_val()) / float(self.total_train_num.get_val())
